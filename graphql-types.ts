...
export type MdxFieldsEnum =
  ...
  | 'frontmatter___image___childrenMdx___gatsbyPath'
  ...
  | 'frontmatter___image___childMdx___gatsbyPath'
...
export type DefaultSeoQueryQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title' | 'description' | 'author' | 'siteUrl' | 'image'>> }> };

export type MdxNodeFragment = (
  Pick<File, 'id'>
  & { childMdx?: Maybe<(
    Pick<Mdx, 'id' | 'body'>
    & { frontmatter?: Maybe<(
      Pick<MdxFrontmatter, 'title'>
      & { image?: Maybe<NewGatsbyImageFragment> }
    )> }
  )> }
);

export type NewGatsbyImageFragment = (
...
export type TemplatePageQuery = { mdx?: Maybe<MdxNodeFragment> };
